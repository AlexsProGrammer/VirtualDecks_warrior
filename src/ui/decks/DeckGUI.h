...
#include "../waveforms/WaveformDisplay.h"
#include "../waveforms/ZoomedWaveform.h"
#include "../waveforms/JogWheel.h"

#include "../settings/CustomLookAndFeel.h"
#include "../../core/data/Library.h"
#include "../../core/data/TrackDataCache.h"
#include "../../core/analysis/BeatSyncManager.h"
#include "../../core/effects/FxIds.h"
#include "DeckQueue.h"
#include "../../utilities/IconTabButton.h"
//==============================================================================
...
public:
	...
	*/
	...
	/// Hover image for the headphone icon when the button is not active.
	std::unique_ptr<juce::Drawable> cueButtonImageHover;
	...
	/// Hover image for the sync bolt icon when not engaged.
	std::unique_ptr<juce::Drawable> fastSyncBtnImageHover;
